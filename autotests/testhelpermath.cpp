...
private Q_SLOTS:
    ...
    void testRoundToIntMultiple()
    {
        // Round to a multiple of 0 is not defined. By convention, it should
        // be treated like a multiple of 1.
        QCOMPARE(roundToIntMultiple(-2.1, 0), -2);
        QCOMPARE(roundToIntMultiple(-2.0, 0), -2);
        QCOMPARE(roundToIntMultiple(-1.9, 0), -2);
        QCOMPARE(roundToIntMultiple(-1.5, 0), -2);
        QCOMPARE(roundToIntMultiple(-1.6, 0), -2);
        QCOMPARE(roundToIntMultiple(-1.4, 0), -1);
        QCOMPARE(roundToIntMultiple(-1.1, 0), -1);
        QCOMPARE(roundToIntMultiple(-1.0, 0), -1);
        QCOMPARE(roundToIntMultiple(-0.9, 0), -1);
        QCOMPARE(roundToIntMultiple(-0.6, 0), -1);
        QCOMPARE(roundToIntMultiple(-0.5, 0), -1);
        QCOMPARE(roundToIntMultiple(-0.4, 0), 0);
        QCOMPARE(roundToIntMultiple(-0.1, 0), 0);
        QCOMPARE(roundToIntMultiple(-0.0, 0), 0);
        QCOMPARE(roundToIntMultiple(0.0, 0), 0);
        QCOMPARE(roundToIntMultiple(0.1, 0), 0);
        QCOMPARE(roundToIntMultiple(0.4, 0), 0);
        QCOMPARE(roundToIntMultiple(0.5, 0), 1);
        ...
        QCOMPARE(roundToIntMultiple(2.0, 0), 2);
        QCOMPARE(roundToIntMultiple(2.1, 0), 2);
        QCOMPARE(roundToIntMultiple(2.4, 0), 2);
        QCOMPARE(roundToIntMultiple(2.5, 0), 3);
        QCOMPARE(roundToIntMultiple(2.6, 0), 3);
        QCOMPARE(roundToIntMultiple(2.9, 0), 3);

        // Multiple of 1
        QCOMPARE(roundToIntMultiple(-2.1, 1), -2);
        QCOMPARE(roundToIntMultiple(-2.0, 1), -2);
        QCOMPARE(roundToIntMultiple(-1.9, 1), -2);
        QCOMPARE(roundToIntMultiple(-1.6, 1), -2);
        QCOMPARE(roundToIntMultiple(-1.5, 1), -2);
        QCOMPARE(roundToIntMultiple(-1.4, 1), -1);
        QCOMPARE(roundToIntMultiple(-1.1, 1), -1);
        QCOMPARE(roundToIntMultiple(-1.0, 1), -1);
        QCOMPARE(roundToIntMultiple(-0.9, 1), -1);
        QCOMPARE(roundToIntMultiple(-0.6, 1), -1);
        QCOMPARE(roundToIntMultiple(-0.5, 1), -1);
        QCOMPARE(roundToIntMultiple(-0.4, 1), 0);
        QCOMPARE(roundToIntMultiple(-0.1, 1), 0);
        QCOMPARE(roundToIntMultiple(-0.0, 1), 0);
        QCOMPARE(roundToIntMultiple(0.0, 1), 0);
        QCOMPARE(roundToIntMultiple(0.1, 1), 0);
        QCOMPARE(roundToIntMultiple(0.4, 1), 0);
        QCOMPARE(roundToIntMultiple(0.5, 1), 1);
        ...
        QCOMPARE(roundToIntMultiple(2.0, 1), 2);
        QCOMPARE(roundToIntMultiple(2.1, 1), 2);
        QCOMPARE(roundToIntMultiple(2.4, 1), 2);
        QCOMPARE(roundToIntMultiple(2.5, 1), 3);
        QCOMPARE(roundToIntMultiple(2.6, 1), 3);
        QCOMPARE(roundToIntMultiple(2.9, 1), 3);

        // Multiple of -1 should behave like multiple of 1
        QCOMPARE(roundToIntMultiple(-2.1, -1), -2);
        QCOMPARE(roundToIntMultiple(-2.0, -1), -2);
        QCOMPARE(roundToIntMultiple(-1.9, -1), -2);
        QCOMPARE(roundToIntMultiple(-1.6, -1), -2);
        ...
        // Multiple of 2
        QCOMPARE(roundToIntMultiple(-5.9, 2), -6);
        QCOMPARE(roundToIntMultiple(-5.6, 2), -6);
        QCOMPARE(roundToIntMultiple(-5.5, 2), -6);
        QCOMPARE(roundToIntMultiple(-5.4, 2), -6);
        QCOMPARE(roundToIntMultiple(-5.1, 2), -6);
        QCOMPARE(roundToIntMultiple(-5.0, 2), -6);
        QCOMPARE(roundToIntMultiple(-4.9, 2), -4);
        QCOMPARE(roundToIntMultiple(-4.6, 2), -4);
        QCOMPARE(roundToIntMultiple(-4.5, 2), -4);
        QCOMPARE(roundToIntMultiple(-4.4, 2), -4);
        QCOMPARE(roundToIntMultiple(-4.1, 2), -4);
        QCOMPARE(roundToIntMultiple(-4.0, 2), -4);
        QCOMPARE(roundToIntMultiple(-3.9, 2), -4);
        QCOMPARE(roundToIntMultiple(-3.6, 2), -4);
        QCOMPARE(roundToIntMultiple(-3.5, 2), -4);
        QCOMPARE(roundToIntMultiple(-3.4, 2), -4);
        QCOMPARE(roundToIntMultiple(-3.1, 2), -4);
        QCOMPARE(roundToIntMultiple(-3.0, 2), -4);
        QCOMPARE(roundToIntMultiple(-2.9, 2), -2);
        QCOMPARE(roundToIntMultiple(-2.6, 2), -2);
        QCOMPARE(roundToIntMultiple(-2.5, 2), -2);
        QCOMPARE(roundToIntMultiple(-2.4, 2), -2);
        QCOMPARE(roundToIntMultiple(-2.1, 2), -2);
        QCOMPARE(roundToIntMultiple(-2.0, 2), -2);
        QCOMPARE(roundToIntMultiple(-1.9, 2), -2);
        QCOMPARE(roundToIntMultiple(-1.6, 2), -2);
        QCOMPARE(roundToIntMultiple(-1.5, 2), -2);
        QCOMPARE(roundToIntMultiple(-1.4, 2), -2);
        QCOMPARE(roundToIntMultiple(-1.1, 2), -2);
        QCOMPARE(roundToIntMultiple(-0.9, 2), 0);
        QCOMPARE(roundToIntMultiple(-0.6, 2), 0);
        QCOMPARE(roundToIntMultiple(-0.5, 2), 0);
        QCOMPARE(roundToIntMultiple(-0.4, 2), 0);
        QCOMPARE(roundToIntMultiple(-0.1, 2), 0);
        QCOMPARE(roundToIntMultiple(-0.0, 2), 0);
        QCOMPARE(roundToIntMultiple(0.0, 2), 0);
        QCOMPARE(roundToIntMultiple(0.1, 2), 0);
        QCOMPARE(roundToIntMultiple(0.4, 2), 0);
        QCOMPARE(roundToIntMultiple(0.5, 2), 0);
        QCOMPARE(roundToIntMultiple(0.6, 2), 0);
        QCOMPARE(roundToIntMultiple(0.9, 2), 0);
        QCOMPARE(roundToIntMultiple(1.0, 2), 2);
        QCOMPARE(roundToIntMultiple(1.1, 2), 2);
        QCOMPARE(roundToIntMultiple(1.4, 2), 2);
        QCOMPARE(roundToIntMultiple(1.5, 2), 2);
        QCOMPARE(roundToIntMultiple(1.6, 2), 2);
        ...
        // Multiple of -2 should be like multiple of 2
        QCOMPARE(roundToIntMultiple(-5.9, -2), -6);
        QCOMPARE(roundToIntMultiple(-5.6, -2), -6);
        QCOMPARE(roundToIntMultiple(-5.5, -2), -6);
        QCOMPARE(roundToIntMultiple(-5.4, -2), -6);
        ...
        // Multiple of 3
        QCOMPARE(roundToIntMultiple(-5.9, 3), -6);
        QCOMPARE(roundToIntMultiple(-5.6, 3), -6);
        QCOMPARE(roundToIntMultiple(-5.5, 3), -6);
        QCOMPARE(roundToIntMultiple(-5.4, 3), -6);
        QCOMPARE(roundToIntMultiple(-5.1, 3), -6);
        QCOMPARE(roundToIntMultiple(-5.0, 3), -6);
        QCOMPARE(roundToIntMultiple(-4.9, 3), -6);
        QCOMPARE(roundToIntMultiple(-4.6, 3), -6);
        QCOMPARE(roundToIntMultiple(-4.5, 3), -6);
        QCOMPARE(roundToIntMultiple(-4.4, 3), -3);
        QCOMPARE(roundToIntMultiple(-4.1, 3), -3);
        QCOMPARE(roundToIntMultiple(-4.0, 3), -3);
        QCOMPARE(roundToIntMultiple(-3.9, 3), -3);
        QCOMPARE(roundToIntMultiple(-3.6, 3), -3);
        QCOMPARE(roundToIntMultiple(-3.5, 3), -3);
        QCOMPARE(roundToIntMultiple(-3.4, 3), -3);
        QCOMPARE(roundToIntMultiple(-3.1, 3), -3);
        QCOMPARE(roundToIntMultiple(-3.0, 3), -3);
        QCOMPARE(roundToIntMultiple(-2.9, 3), -3);
        QCOMPARE(roundToIntMultiple(-2.6, 3), -3);
        QCOMPARE(roundToIntMultiple(-2.5, 3), -3);
        QCOMPARE(roundToIntMultiple(-2.4, 3), -3);
        QCOMPARE(roundToIntMultiple(-2.1, 3), -3);
        QCOMPARE(roundToIntMultiple(-2.0, 3), -3);
        QCOMPARE(roundToIntMultiple(-1.9, 3), -3);
        QCOMPARE(roundToIntMultiple(-1.6, 3), -3);
        QCOMPARE(roundToIntMultiple(-1.5, 3), -3);
        QCOMPARE(roundToIntMultiple(-1.4, 3), 0);
        QCOMPARE(roundToIntMultiple(-1.1, 3), 0);
        QCOMPARE(roundToIntMultiple(-0.9, 3), 0);
        QCOMPARE(roundToIntMultiple(-0.6, 3), 0);
        QCOMPARE(roundToIntMultiple(-0.5, 3), 0);
        QCOMPARE(roundToIntMultiple(-0.4, 3), 0);
        QCOMPARE(roundToIntMultiple(-0.1, 3), 0);
        QCOMPARE(roundToIntMultiple(-0.0, 3), 0);
        QCOMPARE(roundToIntMultiple(0.0, 3), 0);
        QCOMPARE(roundToIntMultiple(0.1, 3), 0);
        QCOMPARE(roundToIntMultiple(0.4, 3), 0);
        QCOMPARE(roundToIntMultiple(0.5, 3), 0);
        QCOMPARE(roundToIntMultiple(0.6, 3), 0);
        QCOMPARE(roundToIntMultiple(0.9, 3), 0);
        QCOMPARE(roundToIntMultiple(1.0, 3), 0);
        QCOMPARE(roundToIntMultiple(1.1, 3), 0);
        QCOMPARE(roundToIntMultiple(1.4, 3), 0);
        QCOMPARE(roundToIntMultiple(1.5, 3), 3);
        QCOMPARE(roundToIntMultiple(1.6, 3), 3);
    ...
    void testRoundToFloatMultiple()
    {
        // Multiple of 0.25
        QCOMPARE(roundToFloatMultiple(0.376, 0.25), 0.5);
        QCOMPARE(roundToFloatMultiple(0.31, 0.25), 0.25);
        QCOMPARE(roundToFloatMultiple(0.25, 0.25), 0.25);
        QCOMPARE(roundToFloatMultiple(0.13, 0.25), 0.25);
        QCOMPARE(roundToFloatMultiple(0.10, 0.25), 0);
        QCOMPARE(roundToFloatMultiple(-0.10, 0.25), 0);
        QCOMPARE(roundToFloatMultiple(-0.20, 0.25), -0.25);
        QCOMPARE(roundToFloatMultiple(-3.20, 0.25), -3.25);

        // Multiple of -0.25 is like multiple of 0.25
        QCOMPARE(roundToFloatMultiple(0.376, -0.25), 0.5);
        QCOMPARE(roundToFloatMultiple(0.31, -0.25), 0.25);
        QCOMPARE(roundToFloatMultiple(0.25, -0.25), 0.25);
        QCOMPARE(roundToFloatMultiple(0.13, -0.25), 0.25);
        ...
        // Multiple of 0 is not meaningful and results in a no-operation
        QCOMPARE(roundToFloatMultiple(0.376, 0), 0.376);
        QCOMPARE(roundToFloatMultiple(0.31, 0), 0.31);
        QCOMPARE(roundToFloatMultiple(0.25, 0), 0.25);
        QCOMPARE(roundToFloatMultiple(0.13, 0), 0.13);
        QCOMPARE(roundToFloatMultiple(0.10, 0), 0.10);
        QCOMPARE(roundToFloatMultiple(-0.10, 0), -0.10);
        QCOMPARE(roundToFloatMultiple(-0.20, 0), -0.20);
        QCOMPARE(roundToFloatMultiple(-3.20, 0), -3.20);

        // Multiple of 1 is like normal rounding
        QCOMPARE(roundToFloatMultiple(0.376, 1), 0);
        QCOMPARE(roundToFloatMultiple(0.31, 1), 0);
        QCOMPARE(roundToFloatMultiple(0.25, 1), 0);
        QCOMPARE(roundToFloatMultiple(0.13, 1), 0);
        QCOMPARE(roundToFloatMultiple(0.10, 1), 0);
        QCOMPARE(roundToFloatMultiple(-0.10, 1), 0);
        QCOMPARE(roundToFloatMultiple(-0.20, 1), 0);
        QCOMPARE(roundToFloatMultiple(-3.20, 1), -3);
    }
};
