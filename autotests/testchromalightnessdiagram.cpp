...
private Q_SLOTS:
    ...
    void testSetCurrentColorLchFromWidgetPixelPosition1()
    {
        // Also very small widget sizes should not crash the widget.
    ...
    void testSetCurrentColorLchFromWidgetPixelPosition2()
    {
        ...
        color = myWidget.currentColorLch();
    ...
    void testFromWidgetPixelPositionToColor()
    {
        ...
        const QPoint negative(-10, -20);
        myWidget.resize(QSize());
        Q_UNUSED(myWidget.d_pointer->fromWidgetPixelPositionToLch(positive));
        Q_UNUSED(myWidget.d_pointer->fromWidgetPixelPositionToLch(negative));
        myWidget.resize(QSize(-1, -1));
        Q_UNUSED(myWidget.d_pointer->fromWidgetPixelPositionToLch(positive));
        Q_UNUSED(myWidget.d_pointer->fromWidgetPixelPositionToLch(negative));
        myWidget.resize(QSize(-1, 0));
    ...
    void testKeyPressEvent()
    {
        ...
        QCOMPARE(myDiagram.currentColorLch().first, 50);
        QCOMPARE(myDiagram.currentColorLch().second, 20);
        QCOMPARE(myDiagram.currentColorLch().third, 180);

        // Actual test:

        myDiagram.setCurrentColorLch(referenceColorLch);
        QTest::keyClick(&myDiagram, Qt::Key_Left);
        QVERIFY(myDiagram.currentColorLch().first == referenceColorLch.first);
        QVERIFY(myDiagram.currentColorLch().second < referenceColorLch.second);
        QVERIFY(myDiagram.currentColorLch().third == referenceColorLch.third);
        ...
        myDiagram.setCurrentColorLch(referenceColorLch);
        QTest::keyClick(&myDiagram, Qt::Key_Left);
        QCOMPARE(myDiagram.currentColorLch().first, referenceColorLch.first);
        QCOMPARE(myDiagram.currentColorLch().second, referenceColorLch.second);
        QCOMPARE(myDiagram.currentColorLch().third, referenceColorLch.third);
        ...
        myDiagram.setCurrentColorLch(referenceColorLch);
        QTest::keyClick(&myDiagram, Qt::Key_Down);
        QVERIFY(myDiagram.currentColorLch().first >= 0);
        QVERIFY(myDiagram.currentColorLch().second == referenceColorLch.second);
        QVERIFY(myDiagram.currentColorLch().third == referenceColorLch.third);
        ...
        myDiagram.setCurrentColorLch(referenceColorLch);
        QTest::keyClick(&myDiagram, Qt::Key_Up);
        QVERIFY(myDiagram.currentColorLch().first <= 100);
        QVERIFY(myDiagram.currentColorLch().second == referenceColorLch.second);
        QVERIFY(myDiagram.currentColorLch().third == referenceColorLch.third);
    ...
    void testCurrentColorLchProperty()
    {
        ...
        QVERIFY(test.currentColorLch() == color);
        QSignalSpy spy(&test, &ChromaLightnessDiagram::currentColorLchChanged);
        QCOMPARE(spy.size(), 0);
    ...
    void testOutOfGamutColors()
    {
        ...
        QVERIFY( //
            myFirstColor == myWidget.d_pointer->m_currentColorLch);
        ...
        QVERIFY( //
            mySecondColor == myWidget.d_pointer->m_currentColorLch);
    }
    ...
    void testOutOfRange()
    {
        ...
        myWidget.setCurrentColorLch(myFirstColor);
        QVERIFY( //
            myFirstColor == myWidget.currentColorLch());
        QVERIFY( //
            myFirstColor == myWidget.d_pointer->m_currentColorLch);
    ...
    void testNearestInGamutColorByAdjustingChromaLightness()
    {
        ...
        color.second = 20;
        color.third = 10;
        myWidget.setCurrentColorLch(color);
        nearestInGamutColor = //
            myWidget.d_pointer->nearestInGamutLchByAdjustingChromaLightness(color.second, color.first);
    ...
    void testNearestInGamutColorByAdjustingChromaLightnessSmallSize()
    {
        ...
        // nearestInGamutLchByAdjustingChromaLightness() is only
