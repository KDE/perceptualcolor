...
private Q_SLOTS:
    ...
    void testDefaultConstructorAndDestructor1()
    {
        ...
        ColorDialog test(m_srgbBuildinColorEngine, id);
        Q_UNUSED(test);
    }
    ...
    void testDefaultConstructorAndDestructor3()
    {
        ...
        {
            // This should not crash!
            ColorDialog test(m_srgbBuildinColorEngine, id, &myWidget);
            Q_UNUSED(test);
        }
    }
    ...
    void testConstructorQWidget()
    {
        ...
        tempPerceptualDialog2.reset( //
            new ColorDialog(m_srgbBuildinColorEngine, id, tempWidget.data()));
    ...
    void testConstructorQColorQWidget()
    {
        ...
        m_perceptualDialog.reset( //
            new ColorDialog(m_srgbBuildinColorEngine, id, color));
        QScopedPointer<QWidget> tempWidget{new QWidget()};
        QScopedPointer<ColorDialog> tempPerceptualDialog2{
            //
            new ColorDialog( //
    ...
    void testConformanceWithQColorDialog()
    {
        ...
        m_perceptualDialog.reset( //
            new ColorDialog(m_srgbBuildinColorEngine, id, initialColor));
    ...
    {
        m_perceptualDialog.reset( //
            new ColorDialog(m_srgbBuildinColorEngine, id, QColor(Qt::white)));
        m_qDialog.reset(new QColorDialog);
        m_perceptualDialog->setOption( //
            QColorDialog::ShowAlphaChannel);
        QVERIFY2( //
    ...
    {
        QScopedPointer<ColorDialog> myDialog( //
            new ColorDialog(m_srgbBuildinColorEngine, id, QColor(50, 127, 206)));
