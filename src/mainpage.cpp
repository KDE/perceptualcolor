 ...
 * - … provides @ref i18nl10n including right-to-left layouts.
 * - … provides @ref hidpisupport.
 * - … uses QStyle wherever possible.
 * - … provides @ref qtstylesheetssupport where is makes sense.
 ...
 *   namespace @ref PerceptualColor. (Exception: The
