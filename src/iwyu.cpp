...
// IWYU does not check headers that do not have a cpp file with the same name.
// We declare them by pragma here to forece a check:

#include "asyncimageprovider.h" // IWYU pragma: associated
#include "constpropagatingrawpointer.h" // IWYU pragma: associated
